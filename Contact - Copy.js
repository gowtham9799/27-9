...
function Contact() {
        ...
        return (
            ...
            <button onClick={()=> setOpen(!open)} className="flex w-full justify-end pr-10 pt-2 text-white font-medium ml-3  opacity-50 hover:opacity-100">CONTACT US
            <IoIosContacts className='w-6 h-6 text-white ml-2'/>
            </button>
            ...
            <Dialog as="div" className="relative z-10" onClose={setOpen}>
                ...
                <div className="absolute inset-0 overflow-hidden">
                    ...
                    <Transition.Child
                        ...
                        <div className="flex flex-wrap justify-between py-4  border-b-2 shadow-lg shadow-gray-300  absolute bg-gray-700 w-full z-10 rounded-b-xl">
                            ...
                            <div className="mt-24 ml-12">
                                ...
                                <div className='w-80 h-32 bg-gray-200 border flex flex-wrap justify-center font-medium rounded-xl shadow-md shadow-gray-400'>
...
<Link to={""} className="text-cyan-600 font-medium"> @Myunde.com </Link>
...
<label htmlFor="price" className=" ml-1 block text-sm font-medium text-gray-700 drop-shadow-lg"> YOUR NAME <span className='text-red-400'> *</span> </label>
 <input type="text"  name="price"  id="price" className=" rounded-lg border-gray-300 w-[23rem] focus:border-black focus:ring-black sm:text-sm mt-1" placeholder="your name" />
...
<textarea type="text"  name="price"  id="price" maxLength="500" className=" mt-2 rounded-lg border-gray-300 w-[23rem] focus:border-black focus:ring-black sm:text-sm pb-16" placeholder="(500 CHARACTERS MAX)" />
</div>
<div className='mt-3'>
<p className='uppercase font-medium text-md'><span className='text-red-400'> * </span> required field</p>
</div>
<div className='py-6 flex justify-center'>
<button className='bg-brand px-6  p-1 rounded-lg    shadow-md shadow-gray-400'> send feedback</button>
</div>
