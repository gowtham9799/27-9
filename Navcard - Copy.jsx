...
function Profile() {
    ...
    return (
        <div className='z-50'>
            ...
            <button
                type="button"
                className="  float-right mt-7"
                onClick={() => setOpen(!open)}>
                <span className="sr-only ">Close panel</span>
                <BsBell className='w-7 h-7 ml-5  mt-5 text-white  opacity-50 hover:opacity-100'/>
            </button>
                                                ...
                                                {/* <----------------------------------profile edit area-----------------------------------------------------> */}
                                                 ...
                                                 <div className='h-auto w-[29.4rem]  '>
                                                    ...
                                                    <div className='h-10 bg-black flex justify-between'>
                                                        ...
                                                        <h5 className='text-start text-white mt-2 mr-52 text-xl'>EMPTY CART</h5>
...
<RiShoppingCartLine className='w-24 h-24 text-light  mt-10'/>
 ...
 <div className='mb-12'>
    <p className='  text-center'> We're on snooze here!</p>
...
<Link to={""} >
 ...
 <div className="text-start px-1 flex">
           <del className="text-lg  text-white dark:text-white pl-5">{pro.price}</del>  
           <p className='text-red-500 pl-4 text-lg '>{pro.old_price}</p>     
</div>
