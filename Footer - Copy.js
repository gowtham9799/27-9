...
function Footer() {
  ...
  return (
      ...
      <body className='from-gray-700  to-gray-100 z-50 text-white'>

      <div className='z-50 '>

      <main className="flex-1 overflow-y-scroll mt-20 gow z-50">  
            
                                    
                                          
                                             
                                                  <div className="flex flex-wrap mt-4 ml-3 sm:ml-8 text-lg z-50">
           ...
           <hr/>
                ...
                <div className=" text-center sm:text-start sm:flex sm:justify-between divide-y-2 divide-dotted sm:divide-y-0 divide-gray-300 px-5">
