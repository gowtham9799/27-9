    ...
    return (
        <div className='mt-[-1.4rem] z-50 '>
            <button
                ...
                <BsCart4 className='w-7 h-7 ml-5  text-white absolute  opacity-50 hover:opacity-100' />
            </button>
...
{go.login && (
    <div className='px-8 '>
                                                <div className='  mt-10  h-[18rem] rounded-xl text-center  px-8 border shadow-lg shadow-gray-300  opacity-50 hover:opacity-100'>
                                                    ...
                                                    <button className=' w-[90%] shadow-sm  border border-slate-300 hover:border-red-400 mt-[30px] rounded-lg' onClick={()=>setGo({...go, loginmob:!go.loginmob ,login:!go.login})}>
                                                        <div className='flex bg-white  h-8   items-center justify-center rounded-lg'>
                                                    ...
                                                    <button className=' w-[90%] shadow-sm  border border-slate-300 hover:border-red-400 mt-[30px] rounded-lg' onClick={()=>setGo({...go, loginmai:!go.loginmai,login:!go.login})}>
                                                    <div className='flex bg-white  h-8   items-center justify-center rounded-lg'>
...
{/* <-------------------------------------------------Login mobile number----------------------------------------------------------------------> */}
{go.loginmob && (
    <div>         <div className='shadow-md mt-10  h-[26rem] rounded-lg text-center border border-white shadow-white-lg px-8 opacity-50 hover:opacity-100 mx-4'>
                                                    <h4 className='text-center pt-[10px] pb-5 text-xl text-white'>Login Using Mobile Number</h4>
                                                    <h6 className=' text-start pt-2 pl-8 text-white'>User Name</h6>
                                                    <input type="tel" className=" w-[85%] h-[30px]  focus:outline-none border-b-2 rounded-lg" ></input>
                                                    <h6 className=' text-start pt-3 pl-8 text-white'> Phone Number</h6>
                                                    <input type="tel" className="w-[85%] h-[30px]  focus:outline-none border-b-2 rounded-lg" ></input>
                                                    <button
                                                        className='text-center bg-red-400 w-[30%] text-black h-[25px] mt-[20px] rounded-2xl '> LOG IN
                                                    </button>
                                                    ...
                                                    <button className=' w-[85%] shadow-sm  border border-slate-300 hover:border-red-400 mt-[20px] ' onClick={()=>setGo({...go, loginmai:!go.loginmai,loginmob:!go.loginmob})}>
                                                        <div className='flex bg-white  h-8   items-center justify-center'>
...
{go.loginmai  && (
    <div>      
                                       <div className='mt-10  h-[28rem] rounded-lg text-center border border-white shadow-white-lg  opacity-60 hover:opacity-100 px-8 mx-6'>
                                                    <h4 className='text-center pt-[10px] text-xl text-white'>Login Using Mail</h4>
                                                    <h6 className=' text-start pt-2 pl-7 text-white'>Email id</h6>
                                                    <input type="tel" className=" w-[85%] h-[25px]  focus:outline-none border-b-2 rounded-lg" ></input>
                                                    <h6 className=' text-start pt-3 pl-7 text-white'>password</h6>
                                                    <input type="tel" className=" w-[85%] h-[25px]  focus:outline-none border-b-2 rounded-lg" ></input>
                                                    ...
                                                    <button className=' w-[85%] shadow-sm  border border-slate-300 hover:border-red-400 mt-[20px]' onClick={()=>setGo({...go, loginmob:!go.loginmob ,loginmai:!go.loginmai})}>
                                                        <div className='flex bg-white  h-8   items-center justify-center'>
...
{go.register && (
    <div>      
                                                        <div className=' mt-10  h-[32rem] rounded-lg text-center border border-white shadow-white-lg  opacity-60 hover:opacity-100 px-8 mx-6'>
                                                    ...
                                                    <h6 className='text-center mt-[20px] text-white'> (or)</h6>
                                                    <h6 className=' text-start pt-2 pl-5 text-white'>Name</h6>
                                                    <input type="tel" className=" w-[90%] h-[25px]  focus:outline-none border-b-2 rounded-lg" ></input>
                                                    <h6 className=' text-start pt-3 pl-5 text-white'> Phone Number</h6>
                                                    <input type="tel" className="w-[90%]  focus:outline-none border-b-2 rounded-lg" ></input>
                                                    <div>
                                                        <h6 className='  pt-3 pr-5 float-right inline text-white'> OTP will be sent for verification</h6>
                                                    </div>
                                                    <h6 className=' text-start pt-2 pl-5 mt-10 text-white'>Email ID</h6>
                                                    <input type="tel" className=" w-[90%] h-[25px]  focus:outline-none border-b-2 rounded-lg" ></input>
                                                    <div>
                                                        <button className='text-center bg-red-400 w-[30%] text-white h-[25px] mt-3 ml-5 rounded-md'>REGISTER</button>
                                                    </div>
                                                    <h6 className='text-center mt-3 text-lg text-white'> By proceeding, you agree to Zivame<span className='text-white text-lg mr-2'><span className='text-red-400 text-lg mr-2 '>Privacy Policy</span> and</span><span className='text-red-400 text-lg mr-2'>rerms & conditions</span> </h6>
                                                </div>
                                                <h6 className='mt-3 ml-20 text-lg text-white'>Already have an account?<span className='text-red-400 text-lg'> Login</span></h6>
                                            </div>
